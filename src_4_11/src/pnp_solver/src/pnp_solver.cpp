...
void PnpSolver::LoadCameraParams() {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        string param_name_close_x = close_parent_name + to_string(i+1) + ".x";
        string param_name_close_y = close_parent_name + to_string(i+1) + ".y";
        string param_name_close_z = close_parent_name + to_string(i+1) + ".z";
    ...
    cout << endl << "close_distCoeffs:" << endl << close_distCoeffs_ << endl;
}
...
void PnpSolver::LoadPnpParams() {
    ...
    // loop 4 times to get 4 corner points
    for (int i = 0; i < 4; i++) {
        string parent_name_far = "calibrate_default_points.farCam.point";
        string param_name_x_far = parent_name_far + to_string(i+1) + ".x";
        string param_name_y_far = parent_name_far + to_string(i+1) + ".y";

        string parent_name_close = "calibrate_default_points.closeCam.point";
...
//    this->declare_parameter<std::string>("battle_state.battle_color", "empty");
    ...
    this->declare_parameter<double>("sensor_far.camera_matrix.zerozero", 0);
    this->declare_parameter<double>("sensor_far.camera_matrix.zerotwo", 0);
    this->declare_parameter<double>("sensor_far.camera_matrix.oneone", 0);
    this->declare_parameter<double>("sensor_far.camera_matrix.onetwo", 0);
    this->declare_parameter<double>("sensor_far.camera_matrix.twotwo", 0);
    this->declare_parameter<double>("sensor_far.distortion_coefficient.zero", 0);
    this->declare_parameter<double>("sensor_far.distortion_coefficient.one", 0);
    this->declare_parameter<double>("sensor_far.distortion_coefficient.two", 0);
    this->declare_parameter<double>("sensor_far.distortion_coefficient.three", 0);
    this->declare_parameter<double>("sensor_far.distortion_coefficient.four", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.zerozero", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.zeroone", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.zerotwo", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.zerothree", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.onezero", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.oneone", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.onetwo", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.onethree", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.twozero", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.twoone", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.twotwo", 0);
    this->declare_parameter<double>("sensor_far.uni_matrix.twothree", 0);

    this->declare_parameter<double>("sensor_close.camera_matrix.zerozero", 0);
    this->declare_parameter<double>("sensor_close.camera_matrix.zerotwo", 0);
    this->declare_parameter<double>("sensor_close.camera_matrix.oneone", 0);
    this->declare_parameter<double>("sensor_close.camera_matrix.onetwo", 0);
    this->declare_parameter<double>("sensor_close.camera_matrix.twotwo", 0);
    this->declare_parameter<double>("sensor_close.distortion_coefficient.zero", 0);
    this->declare_parameter<double>("sensor_close.distortion_coefficient.one", 0);
    this->declare_parameter<double>("sensor_close.distortion_coefficient.two", 0);
    this->declare_parameter<double>("sensor_close.distortion_coefficient.three", 0);
    this->declare_parameter<double>("sensor_close.distortion_coefficient.four", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.zerozero", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.zeroone", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.zerotwo", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.zerothree", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.onezero", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.oneone", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.onetwo", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.onethree", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.twozero", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.twoone", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.twotwo", 0);
    this->declare_parameter<double>("sensor_close.uni_matrix.twothree", 0);
}
