...
#define NODE_MAIN_LOGGER_NAME "depth_sensor_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdepth_sensor.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<get_depth::DepthSensor>";
