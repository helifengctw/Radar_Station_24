...
#define NODE_MAIN_LOGGER_NAME "get_depth_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libGET_DEPTH_LIBS.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<get_depth::Get_Depth_Node>";
