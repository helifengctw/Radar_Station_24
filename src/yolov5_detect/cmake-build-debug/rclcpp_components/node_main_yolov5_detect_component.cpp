...
#define NODE_MAIN_LOGGER_NAME "yolov5_detect_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libyolov5_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<yolov5_detect::Yolov5Detector>";
