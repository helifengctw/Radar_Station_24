...
#define NODE_MAIN_LOGGER_NAME "point_picker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpoints_picker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<utilities::PointsPicker>";
