...
#define NODE_MAIN_LOGGER_NAME "bayer_camera_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhikvision_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<bayer_camera_driver::HikvisionDriver>";
